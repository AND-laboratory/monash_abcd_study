...
model1_ab <- lm(cbcl_scr_dsm5_anxdisord_t ~ abuse, data = ES_long1)
model1_co <- lm(cbcl_scr_dsm5_anxdisord_t ~ connectedness, data = ES_long1)
model1_ha <- lm(cbcl_scr_dsm5_anxdisord_t ~ hardship, data = ES_long1)
