...
fit_test <- cfa(model = model1_test, 
                  data = MB_subsample1,
                  estimator = "ML"
                  )
...
# try again with missing = "ML", estimator = "MLR" - but can't indicate any ordered this way.
...
nsc_p_ss_mean_3_items_rev_z ~~ neighborhood_crime_y_rev_z
